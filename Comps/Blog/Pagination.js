...
const Pagination = ({ numOfPage, currentPage, paginate, paginatePrev, paginateNext }) => {
    ...
    return (
        <div className="pagination mx-md-2 pt-lg-5 pb-2 d-flex justify-content-between align-items-center flex-wrap">
            ...
            <button onClick={() => paginatePrev()} className="pagination-prev-button pagination-control-button position-relative p-0">
            ...
            <button onClick={() => paginateNext()} className="pagination-next-button pagination-control-button position-relative">
