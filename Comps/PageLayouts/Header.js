                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" className="search-icon">
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <path fill="currentColor" fill-rule="nonzero" d="M14.577 12.884h-.892l-.316-.305a7.307 7.307 0 001.773-4.777 7.34 7.34 0 10-7.34 7.34c1.818 0 3.49-.666 4.777-1.773l.305.316v.892l5.646 5.635 1.682-1.682-5.635-5.646zm-6.775 0a5.075 5.075 0 01-5.081-5.082 5.075 5.075 0 015.081-5.081 5.075 5.075 0 015.082 5.081 5.075 5.075 0 01-5.082 5.082z" class="path" />
                            </g>
                        </svg>
