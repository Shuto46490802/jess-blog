...
export default async (req, res) => {
  ...
  try {
    await sendgrid.send({
      to: "shuto.suganuma.0802@gmail.com", // Your email where you'll receive emails
      from: "shuto.suganuma.0802@gmail.com", // your website email address here
  ...
  return res.status(200).json({ error: "Succeed" });
}